            ...
            <div class="main">
                ...
                <div class="report-container">
                    ...
                    <div class="report-header">
                        <h1 class="recent-Articles">Recent categories</h1>
                        <a class="t-op-nextlvl"
                            style="background-color: rgb(60, 229, 255); padding:10px; border-radius:14px;"
                            href="{{ route('category.create') }}" class="btn btn-primary float-right">Add a catégory</a>
                    </div>
                    ...
                    <div class="report-body" style="height: 300px; overflow-y: auto;">
                        ...
                        <div class="items">
                            @forelse ($categories as $category)
                                <div class="item1">
                                    <h3 class="t-op-nextlvl">{{ $category->id }}</h3>
                                    <h3 class="t-op-nextlvl">{{ $category->nom_categorie }}</h3>
                            ...
                            @empty
                                <div class="item1">
                                    <h3 class="t-op-nextlvl">No categories available</h3>
                                </div>
                            @endforelse
                        </div>
                    </div>
